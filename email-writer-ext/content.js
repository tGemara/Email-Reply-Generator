...
function injectButton() {
    ...
    button.style.display = 'inline-block'; // make sure it aligns inline
    button.style.verticalAlign = 'middle'; // align with Send button
    button.style.height = '36px'; // match Send button height
    ...
    // 👉 Insert **AFTER** the Send button for better alignment
